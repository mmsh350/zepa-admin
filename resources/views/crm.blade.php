...
<html lang="en" dir="ltr" data-nav-layout="vertical" data-theme-mode="light" data-header-styles="light" data-menu-styles="dark" data-toggled="close">
   <head>
      ...
      <title>ZEPA Solutions - CRM </title>
      <!-- fav icon -->
            ...
            <div class="main-sidebar" id="sidebar-scroll">
               ...
               <nav class="main-menu-container nav nav-pills flex-column sub-open">
                  <div class="slide-left" id="slide-left">
                   ...
                   @php $title="crm"; $menu="agency"; @endphp
            ...
            <div class="container-fluid">
               ...
               <div class="d-md-flex d-block align-items-center justify-content-between my-2 page-header-breadcrumb">
                  <div>
                     ...
                     <span class="fs-semibold text-muted">Submit CRM request with BMS ID  and Ticket Number for assistance with BVN Issues.</span>
                  </div>
               </div>
               <!-- End::page-header -->
               <!-- Start::row-1 -->
                                 ...
                                 <div class="card custom-card">
                                    ...
                                    <div class="card-body text-center">
                                       ...
                                       <small class=" font-italic"><i>Please note that this request will be processed within 2 working days. We appreciate your patience and will keep you updated on the status.</i></small>
                                         ...
                                         @endif
                                            <form name="crm-request" method="POST" action="{{route('crmRequest')}}">
                                                @csrf
                                                <div class="row mb-2">

                                                     <div class="col-md-12 mt-2">
                                                        <p class="mb-2 form-label"> Ticket ID </p>
                                                        <input type="text" id="ticket_id" name="ticket_id" maxlength="20" class="form-control phone text-center" maxlength="11" required/>
                                                      </div>
                                                     <div class="col-md-12">
                                                        <p class="mb-2 form-label mt-2"> BMS ID </p>
                                                        <input type="text" id="bms_id" name="bms_id" maxlength="8" class="form-control text-center" maxlength="4" required/>
                                                    </div>
                                                     <p class="mt-3 fw-bold"> CRM Request Fee: &#x20A6;{{number_format($ServiceFee),2}}</p>
                                                </div>
                                                <button type="submit" id="crm-request" class="btn btn-primary"><i class="las la-share"></i> Submit Request</button>
                                            </form>
                                    </div>
                                 </div>
                              </div>
...
<script>
        ...
        const submitButton = document.getElementById('crm-request');
