                ...
                <div class="card custom-card">
                    <div class="card-body">
                        <div class="my-2 d-flex justify-content-center">
                            <a href="../">
                                <img src="{{ asset('assets/images/brand-logos/login_logo.png') }}" alt="logo"
                                    class="desktop-logo" style="height:58px">
                            </a>
                        </div>
                        <p class="h5 fw-semibold mb-2  text-center pt-4">Admin Portal</p>
