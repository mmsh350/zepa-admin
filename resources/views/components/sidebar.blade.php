<ul class="main-menu">
   ...
   <li class="slide has-sub @if($menu == 'wallet') open @endif">
      ...
      <ul class="slide-menu child1">
         <li class="slide">
            <a href="{{route('funding')}}" class="side-menu__item @if($title == 'funding') active @endif">Funding</a>
         </li>
         <li class="slide">
            <a href="{{route('p2p')}}" class="side-menu__item @if($title == 'p2p') active @endif">P2P
            </a>
         </li>
         <li class="slide">
            <a href="{{route('claim')}}" class="side-menu__item @if($title == 'claim') active @endif">Claim Bonus
            </a>
         </li>
      </ul>
   </li>
   ...
   <li class="slide has-sub @if($menu == 'Identity') open @endif">
      ...
      <ul class="slide-menu child1">
         <li class="slide has-sub">
            <a href="javascript:void(0);" class="side-menu__item">  NIN Verification <i class="fe fe-chevron-right side-menu__angle"></i> <span class="badge bg-secondary-transparent ms-1">soon</span></a>
            <ul class="slide-menu child2">
               <li class="slide">
                  <a href="#" onclick="return confirm('Comming Soon')" class="side-menu__item">  Verify NIN using NIN</a>
               </li>
               <li class="slide">
                  <a href="#" onclick="return confirm('Comming Soon')" class="side-menu__item">Verify NIN using Phone No
                  </a>
               </li>
               <li class="slide">
         ...
         <li class="slide">
            <a href="{{route('bank')}}" class="side-menu__item @if($title == 'BANK') active @endif">Verify Bank Account</a>
         </li>
      </ul>
   </li>
   <!-- End::slide -->
      ...
      <ul class="slide-menu child1">
         ...
         <li class="slide">
            ...
            <ul class="slide-menu child2">
               ...
               <li class="slide">
                  <a href="#" onclick="return confirm('Comming Soon')" class="side-menu__item">SME Data Bundle
 ...
 <li class="slide">
   ...
   <li class="slide has-sub @if($menu == 'agency') open @endif">
      ...
      <ul class="slide-menu child1">
         ...
         <li class="slide">
            <a href="#" onclick="return confirm('Comming Soon')" class="side-menu__item">BVN Enrollement Agency Request
            </a>
         </li>
      </ul>
   </li>
   ...
   <li class="slide has-sub @if($menu == 'users') open @endif">
      ...
      <ul class="slide-menu child1">
         <li class="slide">
            <a href="{{route('verification.kyc')}}" class="side-menu__item @if($title == 'kyc') active @endif">KYC Verification</a>
         </li>
         <li class="slide">
