<aside class="app-sidebar sticky"
    ...
    <div class="main-sidebar-header">
        <a href="{{ route('dashboard') }}"
           class="header-logo">
            <img src="{{ asset('assets/images/brand-logos/logo.png') }}"
                 alt="logo"
                 class="desktop-logo">
            <img src="{{ asset('assets/images/brand-logos/logo.png') }}"
                 alt="logo"
            ...
            <ul class="main-menu">
                ...
                <li
                    ...
                    <a href="javascript:void(0);"
                       class="side-menu__item {{ request()->is('funding') || request()->is('p2p') || request()->is('claim') || request()->is('transfer') ? 'active' : '' }}">
                        <i class="bx bx-wallet side-menu__icon"></i> <box-icon type='solid'
                                  name='wallet'></box-icon>
                ...
                <li
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide">
                            <a href="#"
                               onclick="return confirm('Comming soon!');"
