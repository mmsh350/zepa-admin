                                    ...
                                    <div class="card custom-card ">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="col-12  mb-3">
                                                <form action="{{ route('nin-services') }}" method="GET">
                                                    <div class="row g-2">
                                                        <div class="col-md-3">
                                            ...
                                            @if (!$nin->isEmpty())
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table text-nowrap" style="background:#fafafc !important">
                                                        <thead>
                                                            <tr>
                                                                <th width="5%" class="cust2 text-light" scope="col">
                                                                    ID</th>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center">
                                                                        @if ($data->status == 'resolved')
                                                                            <span
                                                                                class="badge bg-success-transparent">{{ Str::upper($data->status) }}</span>
                                                                        @elseif ($data->status == 'rejected')
                                                                            <span
                                                                                class="badge bg-danger-transparent">{{ Str::upper($data->status) }}</span>
                                                                        @elseif ($data->status == 'pending')
                                                                            <span
                                                                                class="badge bg-warning-transparent">{{ Str::upper($data->status) }}</span>
                                                                        @else
                                                                            <span
                                                                                class="badge bg-primary-transparent">{{ Str::upper($data->status) }}</span>
                                                                        @endif
                                                                    </td>
                                                                    <td>
                                                    ...
                                                    <div class="d-flex justify-content-center">
                                                        {{ $nin->links('vendor.pagination.bootstrap-5') }}
                                                    </div>
                                                </div>
                                            @else
