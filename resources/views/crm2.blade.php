...
<html lang="en" dir="ltr" data-nav-layout="vertical" data-theme-mode="light" data-header-styles="light" data-menu-styles="dark" data-toggled="close">
   <head>
      ...
      <title>ZEPA Solutions - CRM With Phone No & DOB</title>
      <!-- fav icon -->
            ...
            <div class="main-sidebar" id="sidebar-scroll">
               ...
               <nav class="main-menu-container nav nav-pills flex-column sub-open">
                  <div class="slide-left" id="slide-left">
                   ...
                   @php $title="crm2"; $menu="agency"; @endphp
            ...
            <div class="container-fluid">
               ...
               <div class="d-md-flex d-block align-items-center justify-content-between my-2 page-header-breadcrumb">
                  <div>
                     ...
                     <span class="fs-semibold text-muted">Submit a CRM request using your BVN, phone number, and date of birth (DOB) to receive assistance with BVN-related issues.</span>
                  </div>
               </div>
               <!-- End::page-header -->
               <!-- Start::row-1 -->
                                 ...
                                 <div class="card custom-card">
                                    ...
                                    <div class="card-body text-center">
                                       ...
                                       <small class=" font-italic"><i>Please note that this request will be processed within 2 working days. We appreciate your patience and will keep you updated on the status.</i></small>
                                         ...
                                         @endif
                                            <form name="crm2-request" method="POST" action="{{route('crmRequest2')}}">
                                                @csrf
                                                <div class="mb-2 row">
                                                     <div class="col-md-12 mt-2">
                                                        <p class="mb-2 form-label"> Phone Number </p>
                                                        <input type="text" id="phone_number" name="phone_number" maxlength="11" class="form-control phone text-center" required/>
                                                      </div>
                                                     <div class="col-md-12">
                                                        <p class="mb-2 form-label mt-2"> Date of Birth:(mm/dd/yyyy) </p>
                                                        <input type="date" id="dob" name="dob" class="form-control text-center"  required/>
                                                    </div>
                                                      <p class="mt-3 fw-bold"> CRM Request Fee: &#x20A6;{{number_format($ServiceFee),2}}</p>
                                                </div>
                                                <button type="submit" id="crm2-request" class="btn btn-primary"><i class="las la-share"></i> Submit Request</button>
                                            </form>
                                    </div>
                                 </div>
                              </div>
                              ...
                              <div class="card-body">
                                 ...
                                 <div class="table-responsive">
                                   ...
                                   <div class="d-flex justify-content-center">
                                        {{ $crm->links('vendor.pagination.bootstrap-4') }}
                                   </div>
                                 </div>
                                 @else
...
<script>
        ...
        const submitButton = document.getElementById('crm2-request');
