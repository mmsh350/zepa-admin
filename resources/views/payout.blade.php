...
<div class="main-content app-content">
    <div class="container-fluid">
                                                        ...
                                                        <div class="">
                                                            ...
                                                            <div class="col-md-6 col-lg-6 mb-2">
                                                                <label for="input-file"
                                                                       class="form-label">Wallet Balance</label>
                                                                <select name="wbalance"
                                                                        id="wbalance"
                                                            ...
                                                            <div class="col-lg-6 col-md-6 mb-2">
                                                                <label for="input-file"
                                                                       class="form-label">How much do you want to
                                                                    send?</label>
                                                            ...
                                                            <div class="col-md-6 col-lg-6 mb-2">
                                                                <label for="input-file"
                                                                       class="form-label">Remark (Optional) </label>
        ...
        <div class="modal fade"
             id="pinCheckModal"
             tabindex="-1"
             aria-labelledby="pinCheckModalLabel"
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h6 class="modal-title"
                            id="pinCheckModalLabel">Confirm Transaction PIN</h6>
                        <button type="button"
                                class="btn-close"
                        ...
                        <form name="pinCheckForm"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="invalid-feedback"
                                     id="pinErrorMessage">Invalid PIN. Please try again.</div>
                            </div>
                        </form>
                    </div>
                    <div class="modal-footer">
                        ...
                        <button type="button"
                                ...
                                id="verifyPinButton">Proceed</button>
                    </div>
                </div>
            </div>
        </div>
