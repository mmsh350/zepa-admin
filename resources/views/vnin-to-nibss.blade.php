                  ...
                  <div class="col-xxl-12 col-xl-12">
                     <div class="row">
                        ...
                        <div class="col-12  mb-3">
                            <form action="{{ route('vnin-to-nibss') }}" method="GET">
                                <div class="row g-2">
                                    <div class="col-md-3">
    ...
    @if(!$vnin->isEmpty())
        ...
        <div class="table-responsive">
            <table class="table text-nowrap" style="background:#fafafc !important">
                <thead>
                    <tr>
                        ...
                        <th scope="col" class="cust2 text-light">Request ID</th>
                        <th scope="col" class="cust2 text-light">BVN No</th>
            ...
            <div class="d-flex justify-content-center">
                {{ $vnin->links('vendor.pagination.bootstrap-5') }}
            </div>
        </div>
    @else
