            ...
            <div class="col-12">
                <div class="card shadow-sm border-0">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                <div class="p-3 border rounded bg-light">
                                    ...
                                    <p><i class="ti ti-user fs-16"></i> &nbsp;<strong>Full Name:</strong> {{ $requests->user->full_name }}</p>
                            ...
                            <div class="col-md-6 mb-4">
                                <div class="p-3 border rounded bg-light">
                                    ...
                                    <p><strong>Amount:</strong> ₦{{ number_format($requests->transactions->amount, 2) }}</p>
                        ...
                        <div class="mb-4">
                            <div class="p-3 border rounded bg-light">
                               <h6 class="text-uppercase  mb-3"><span class="text-muted">Request Information </span>- <strong>CRM </strong></h6>
                                <div class="row">
                                    <div class="col-md-6">
                         ...
                         <div class="mb-4">
                            <div class="p-3 border rounded bg-light">
                                <h6 class="text-uppercase  mb-3"><span class="text-muted">Request Information </span>- <strong>CRM With Phone No & DOB</strong></h6>
                                <div class="row">
                                    <div class="col-md-6">
                                        <p><strong>Reference No.:</strong> {{ strtoupper($requests->refno) }}</p>
                                           <p><strong>Phone No.:</strong> {{ $requests->phoneno }}</p>
                                        <p><strong>Date of Birth.:</strong> {{ \Carbon\Carbon::parse($requests->dob)->format('d/m/Y') }}</p>
                                    </div>
                                    <div class="col-md-6">
                                        <p><strong>Date:</strong> {{ \Carbon\Carbon::parse($requests->created_at)->format('d/m/Y') }}</p>
                                        <p><strong>Status:</strong>
                        ...
                        <div class="p-3 border rounded bg-light">
                            ...
                            <form action="{{ route('update-request-status', [$requests->id, $request_type]) }}" method="POST" id="statusForm">
                                @csrf
