        ...
        <div class="container-fluid">
            ...
            <div class="d-md-flex d-block align-items-center justify-content-between my-2 page-header-breadcrumb">
                <div>
                    ...
                    <span class="fs-semibold text-muted">Select your preferred funding method to deposit funds into your
                        wallet. If you need assistance, please don't hesitate to contact us.</span>
                </div>
            </div>
            <!-- End::page-header -->
            <!-- Start::row-1 -->
                                                ...
                                                <div class="flex-fill ms-3">
                                                    <div
                                                        ...
                                                        <div>
                                                            ...
                                                            <h4 class="fw-semibold mt-1">
                                                                &#x20A6;{{ number_format($deposit - $walletBalance), 2 }}
                                                            </h4>
                                                        </div>
                                                        <div id="crm-total-deals"></div>
                                                    </div>
                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            <small class="fw-semibold">Fund your wallet instantly by depositing into the
                                                virtual account number</small>
                                            ...
                                            <hr>
                                            <small class="fw-semibol mb-2 text-danger">If your funds is not received within
                                                30mins Please
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="mb-0">
                                                <div id="error" style="display:none"
                                                    class="alert alert-danger alert-dismissible" role="alert"></div>
                                                <div class="flex-space flex-wrap align-items-center">
                                                    <div class="card-wrapper  rounded-3 h-100 w-100 checkbox-checked">
                                                        ...
                                                        <span style="text-transform:none">Choose a payment method, enter the
                                                            funding amount and continue to top up</span>

                                                        <div class="row mt-3">

                                                            <div class="col-md-6">
                                                                <div class="form-check radio radio-primary">
                                                                    <input class="form-check-input" id="ptm44"
                                                                        type="radio" name="radio1" value="moniepoint">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-check radio radio-primary">
                                                                    <input class="form-check-input" id="ptm11"
                                                                        type="radio" name="radio1" value="paystack">
                                                                    <label class="form-check-label mb-0"
                                                                        for="ptm11"><img class="img-fluid"
                                                                            width="50%"
                                                                            src="{{ asset('assets/images//paystack.png') }}"
                                                                            alt="card"><br /> Comming soon!</label>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <form class="row" name="paymentForm" id="paymentForm">
                                                            ...
                                                            <div class="col-4" hidden>
                                                                <input class="form-control" id="desc" type="desc"
                                                                    value="Wallet Top Up" required="">
                                                            </div>
                                                            <input type="text" hidden id="response" />
                                                            <input type="text" hidden id="reference" />
                                                            <div class="col-6 ">
                                                                <label class="col-sm-6 col-form-label">Top up
                                                                    Amount</label>
                                                            ...
                                                            <div class="col-8  ">
                                                                <button class="example-popover btn btn-dark mb-1   mt-3 "
