                            ...
                            <div class="row justify-content-center mb-5">
                                <div class="col-xl-6">
                                   ...
                                   @elseif($mail_data['type'] == 'Verified')
                                         <p class="mb-0 op-7">
                                        We are pleased to inform you that your KYC application has been successfully verified! You can now proceed to access the portal by clicking this link:   </p>
                                    
                                        <br/>
                                  <p>
                                    <a href="https://zepasolutions.com/" class="btn btn-primary"><i class="bi bi-a-circle align-middle me-1 d-inline-block"></i>Proceed</a>
                                  </p>
                                   <p class="mb-0 op-7">  Thank you for your patience and cooperation throughout the verification process.</p>                                     
                                         @endif 
                                         <br/> 
