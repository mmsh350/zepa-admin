$("#verifyNIN").on("click", function (event) {
   ...
   <center><span class="text-danger" style="margin-top:5px;">${result.data.data.message}</span></center>
      <table class="table">
         <thead >
            <tr>
         ...
         <tbody>
            <tr>
              ...
              <tr>
               ...
               <td  style="text-align:left">${result.data.data.trackingid}
               </td>
            </tr>
            <tr>
               <th scope="row" style="text-align:right; border: none ! important;">NIN</th>
               <td style="text-align:left" ><span id="nin_no" >${result.data.data.nin}</span>
               </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="text-align:left">
                    ${result.data.data.gender === 'm' ? 'Male' : result.data.data.gender === 'f' ? 'Female' : 'Not Specified'}
                </td>
            </tr>
            ...
            <tr>
               ...
               <td  style="text-align:left">${result.data.data.residence_AdressLine1}
               </td>
            </tr>
         </tbody>
      </table>
